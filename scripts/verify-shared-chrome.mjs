...
const pages = ['index.html', 'dictionary.html', 'style-lab.html', 'generator.html', 'palettes.html', 'uses.html', 'favorites.html', 'skills.html'];
const pageKeys = {
  'index.html': 'home',
...
const expectedNavLabels = ['浏览色卡', '色彩字典', '场景试色', '配色生成', '配色灵感', '用途卡片', '收藏', 'Skills'];
